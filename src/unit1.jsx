   ...
   return (
      <div>
         ...
         <p>
            ...
            points that have been covered. The learning outcomes are intended to
            provide a skeleton upon which to hang the detail which is covered in
            the text. The summary, by contrast, is intended to assist students
            when they revise, by providing a short overview of the contents to
            let students be confident in their grasp of the material. <br />{" "}
            Throughout each Module, specific syllabus codes are shown alongside
            subheadings to show which parts of the syllabus are being addressed
            in each case, as follows. <br /> The text aims to encourage an
            active learning style and includes many self-assessment questions as
            well as varied longer-answer questions and tasks, while maintaining
            a structured approach to the learning process. <br />{" "}
         ...
         <p>
            ...
            individual work. They are indicated in the text with an i c o n like
            this. <br />
            Other questions are more broadly based and are intended to encourage
            students to find out about a small area of the course, and are often
            suitable for classroom discussion as well as independent thinking.
            We find this type of work to be especially effective because it
            allows students to formulate their own answers - there is often no
            single right answer to the question. These questions are indicated
            with an icon like this. <br />
            Finally, there are Extension questions and tasks. These include
            concepts, examples or thinking that fall beyond the strict
            boundaries of the syllabus. However, addressing these questions will
            deepen students' understanding of and appreciation for the concepts
            being presented. Each of these pieces of work is meant as a starting
            point which may interest students, particularly the more able, and
            encourage them to carry out some independent enquiry into a topic.
            It must be stressed that this work is not an integral part of the
            syllabus requirements and can be omitted without prejudicing
            attainment in the examination. These Extension materials are
            contained within clearly marked boxes, headed like this.
         </p>
         <p>The CD-ROM contains several categories of material.</p>
         <ul>
            <li>Real CIE past exam papers (Papers 1, 2 and 3).</li>
            <li>
               Our exemplar answers for the CIE past papers, including our mark
               scheme for Paper 2 (Practical test A). We have also provided
               comments, indicating common pitfalls or giving some explanation
               of why certain answers are correct or how the marks are awarded
            </li>
            <li>Revision questions (without answers).</li>
            <li>
               Revision notes and tests to ensure that students' revision goes
               smoothly.
            </li>
            <li>
         ...
         <p>
            ...
            reader, and helps students achieve a good grade in the CIE IGCSE in
            ICT.
         </p>
      </div>
   );
